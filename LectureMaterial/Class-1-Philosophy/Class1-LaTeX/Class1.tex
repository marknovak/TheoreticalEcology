...
\end{center}
	...
	\end{equation*}
	Value of $Y$ depends on the \textit{previous} $Y$ value.
...
\begin{multicols}{2}
	...
	e.g., intercept > 0 nonsensical for functional response
	\begin{center}
...
$\implies$ Modern world of process-model fitting \& information-theoretic model comparisons\\
