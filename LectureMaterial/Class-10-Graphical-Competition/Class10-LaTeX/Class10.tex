...
\begin{center}
	\includegraphics[width=16cm]{figs/LV_comp_isoclines.pdf}
\end{center}
...
\textbf{Simulations}\\
\ind \note{R-demonstration - Walk through first set of parameter values.}\\
...
\begin{table*}[h]
	...
	\begin{tabular}{cccc}
		\hline
		$\alpha_{21}$ & $\alpha_{12}$ & Outcome & Initial\\ 
		\hline
		\hline
		0.5 & 0.7 & \textit{coexist} & \\
		1.5 & 0.5 & sp 1 & \\
		0.5 & 1.5 & sp 2 & $N_1(0)=N_2(0)$\\
		1.5 & 1.7 & sp 2 & \\
		\hline
		2 & 2 & sp $i$ & $N_i(0)>N_j(0)$\\
		\hline
		\hline
	\end{tabular} 
\end{table*}
