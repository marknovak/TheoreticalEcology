...
\begin{cases}
	...
	Mathematica output top and bottom by -1}}
\end{cases}
\end{align*}
...
\begin{align*}
	f_1(u_1^* + x, u_2^* + y) = & f_1(u_1^*,u_2^*) + \frac{\frac{\partial f_1}{\partial u_1}}{1! } \cdot x + 
	\frac{\frac{\partial^2 f_1}{\partial u_1^2}}{2! } \cdot x^2 + h.o.t. + \dots \\
	&\quad \quad \quad \quad \dots  + \frac{\frac{\partial f_1}{\partial u_2}}{1!} \cdot y + 
	\frac{\frac{\partial^2 f_1}{\partial u_2^2}}{2!}\cdot y^2 +  h.o.t.\\
...
\begin{center}
	\begin{tabular}{ll}
		...
		$Re(\lambda_i)< 0$ for some $i$ & Saddle point (attractor-repellor) \\ 
		...
		$Im(\lambda_i) \neq 0$ for some $i$  & Oscillations (spiral) \\ 
		\hline
	\end{tabular} 
\end{center}
