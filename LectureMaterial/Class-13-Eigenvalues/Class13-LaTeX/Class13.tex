...
Multiplying by $i$ is equivalent to rotating by $-90^{\circ}$.  \\
Repeat 4 times $\implies$ full rotation (circle).\\
Rotation viewed from either side $\implies$ sine or cosine.\\
