...
\noindent\makebox[\textwidth][c]{\Large\bfseries Lecture 5 -- Density-dependent deterministic growth}
...
\begin{align*}
	N_{t+1}=& N_t+(r_d-\alpha N_t)N_t &\\
	& \textit{(The quadratic discrete logistic growth eqn.)} \\
