...
\title{\textbf{Problem Set}\\Deterministic Growth\vspace{-3em}}
\date{}
\author{}
...
Confirm this by plotting the population's multipilcative growth rate (i.e. the \textit{relative} change in 
$N$ between successive time steps calculated from the data) and its population size. 
That is, calculate $\lambda[t] = N[t+1] / N[t]$ and plot it as a function of $N[t]$.
