...
# Note: It's better (good practice) to specify the length of the N vector ahead of time, but I didn't do it here to make the point about the number of time-points vs. the number of time-steps more obvious.

for (Time in t){ 
  N[Time+1] <- N[Time]*lambda
}

T<-c(t,TimeSteps+1)  # Here's the point:  For x time-steps, there will be x+1 time points because you had N(0) to begin with.
