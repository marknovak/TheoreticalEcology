...
\noindent\makebox[\textwidth][c]{\Large\bfseries Quiz - Monod's Nightmare}
...
\begin{align*}
	...
	N_t=N_0 e^{rt}\\
	ln\left(\frac{N_t}{N_0}\right)&=rt\\
	t&=\frac{ln \left(\frac{4\cdot 10^{20}}{1}\right)}{r}=\frac{ln \left(\frac{4\cdot 
	10^{20}}{1}\right)}{\frac{ln(2)}{20}} \approx \frac{47.438}{0.035} \approx 1369 
	\; \text{minutes} \approx 22.8 \; \text{hours}
\end{align*}}
